    ...
    child: Column(
      ...
      children: <Widget>[
        ...
        normalText(
            ...
            'cancels it. You may cancel your Subscription renewal through your'
            'online account management page (Google Play or App Store).'
...
void showChangeLog(BuildContext context) async {
  Widget title = const Text('What\'s New');
  Widget content = SingleChildScrollView(
    child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: Platform.isAndroid ? androidNewText() : iosNewText()),
  );
  customAlertDialog(
    context: context,
    title: title,
        ...
        builder: (ctx, refresh) {
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                const Text(
                    'Leader\'s Book does not work properly on a government computer. NIPR blocks most of the functionality and, unfortunately, there is no way to get around it.'),
                CheckboxListTile(
