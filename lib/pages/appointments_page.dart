...
class AptsPageState extends ConsumerState<AptsPage> {
  ...
  void initState() {
    ...
    String adUnitId = kIsWeb
        ? ''
        : Platform.isAndroid
            ? 'ca-app-pub-2431077176117105/1007921340'
            : 'ca-app-pub-2431077176117105/1441025986';
        ...
        if (mounted) {
          ...
          toast.showToast(
            child: MyToast(
              ...
              onPressed:
                  kIsWeb ? null : () => OpenFile.open('$dir/appointments.xlsx'),
            ),
          );
        }
      } catch (e) {
    ...
    if (mounted) {
      ...
      toast.showToast(
        child: MyToast(
          ...
          buttonText: kIsWeb ? null : 'Open',
          onPressed:
              kIsWeb ? null : () => OpenFile.open('$location/appointments.pdf'),
        ),
      );
    }
  }
