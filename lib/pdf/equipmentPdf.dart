          ...
          build: (Context context) {
            return Column(children: [
              ...
              Row(children: [
                ...
                createLabeledField(document['buttStock'], 'Butt Stock #', 1.75),
              ...
              Row(children: [
                ...
                createLabeledField(document['opticSerial2'], 'Serial #', 3.25),
              ]),
              Row(children: [
              ...
              Row(children: [
                ...
                createLabeledField(document['miscSerial'], 'Serial #', 3.25),
              ]),
              Row(children: [
                createField('', 3.25),
