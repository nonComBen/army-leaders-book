...
class FlagsPdf {
  ...
  TableRow tableHeader(bool fullPage) {
    return TableRow(children: [
      ...
      headerField('Issued Date', fullPage ? 1.75 : 1.5),
      if (fullPage) headerField('Exp Date', 1.75),
    ]);
  }
        ...
        TableRow(
          children: [
            tableField(
                ...
                2.75),
            tableField(documents[i]['type'], 2.75),
            tableField(documents[i]['date'], fullPage ? 1.75 : 1.5),
            if (fullPage) tableField(documents[i]['exp'], 1.75)
          ],
        ),
      );
    }
