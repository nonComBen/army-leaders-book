              ...
              return Container(
                  child: Column(
                    ...
                    Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          createField(soldier.dodId, 'DoD ID', 2.16),
                    ...
                    Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          createField(soldier.nbcSuitSize, 'CBRN Suit', 2.16),
                          createField(soldier.nbcMaskSize, 'CBRN Mask', 2.16),
                          createField(soldier.nbcBootSize, 'CBRN Boot', 2.17),
                        ]),
                    Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          createField(soldier.nbcGloveSize, 'CBRN Glove', 2.16),
                          createField(soldier.hatSize, 'Hat Size', 2.16),
                          createField(soldier.bootSize, 'Boot Size', 2.17),
                        ]),
                    Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: [
                          createField(soldier.acuTopSize, 'OCP Top Size', 3.25),
                          createField(
                              soldier.acuTrouserSize, 'OCP Trouser Size', 3.25),
                        ]),
                    Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.start,
                  ...
                  Table(
                      ...
                      children: [
                        ...
                        TableRow(children: [
                          ...
                          tableField(
                              awards.isEmpty ? '' : awards[0]['number'], 1.25),
                          tableField(
                              awards.length < 2 ? '' : awards[1]['name'], 2.0),
                          tableField(
                        ...
                        TableRow(children: [
                          tableField(
                              awards.length < 3 ? '' : awards[2]['name'], 2.0),
                          tableField(
                              awards.length < 3 ? '' : awards[2]['number'],
                              1.25),
                          tableField(
                              awards.length < 4 ? '' : awards[3]['name'], 2.0),
                          tableField(
                        ...
                        TableRow(children: [
                          tableField(
                              awards.length < 5 ? '' : awards[4]['name'], 2.0),
                          tableField(
                              awards.length < 5 ? '' : awards[4]['number'],
                              1.25),
                          tableField(
                              awards.length < 6 ? '' : awards[5]['name'], 2.0),
                          tableField(
                        ...
                        TableRow(children: [
                          tableField(
                              awards.length < 7 ? '' : awards[6]['name'], 2.0),
                          tableField(
                              awards.length < 7 ? '' : awards[6]['number'],
                              1.25),
                          tableField(
                              awards.length < 8 ? '' : awards[7]['name'], 2.0),
                          tableField(
                        ...
                        TableRow(children: [
                          tableField(
                              awards.length < 9 ? '' : awards[8]['name'], 2.0),
                          tableField(
                              awards.length < 9 ? '' : awards[8]['number'],
                              1.25),
                          tableField(
                              awards.length < 10 ? '' : awards[9]['name'], 2.0),
                          tableField(
                ...
                children: [
                  Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                      ...
                      createField(soldier.nbcGloveSize, 'CBRN Glove', 2.375),
                    ]),
                    Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                    ...
                    children: [
                      ...
                      Row(
                          ...
                          children: [
                            createField(pov2 == null ? '' : pov2['plate'],
                                "license Plate", 2.25),
                            createField(pov2 == null ? '' : pov2['state'],
                                "State", 1.0),
                            createField(
                                pov2 == null ? '' : pov2['regExp'], 'Exp', 1.5)
                          ]),
                      Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            createField(
                                pov2 == null ? '' : pov2['ins'], 'Ins', 1.625),
                            createField('', 'Policy', 1.625),
                            createField(
                                pov2 == null ? '' : pov2['insExp'], 'Exp', 1.5)
                          ]),
                      Row(
                          mainAxisSize: MainAxisSize.max,
                          mainAxisAlignment: MainAxisAlignment.start,
